...
btn.onclick = function() {
  imageEnd.src = "static/image/16.jpg"
  //alert(0);
  var n1 = Math.round(Math.random()*1000000);
  if (emotion == "happy"){
    imageEnd.src = "static/image/0.png"
    ans = 0;
    imageEnd.alt = ans;
    ...
    if (n1 < 220092){
      imageEnd.src = "static/image/12.png"
      ans = 12;
    }else if (n1 < 420955){
      ans = 13;
      imageEnd.src = "static/image/13.png"
    }else if (n1 < 615104){
      ans = 14;
      imageEnd.src = "static/image/14.png"
    }else if (n1 < 807666){
      ans = 15;
      imageEnd.src = "static/image/15.png"
    }else{
      ans = 16;
      imageEnd.src = "static/image/16.jpg"
    }
    ...
    if (n1 < 220092){
      ans = 4;
      imageEnd.src = "static/image/4.png"
    }else if (n1 < 420955){
      ans = 3;
      imageEnd.src = "static/image/3.png"
    }else if (n1 < 615104){
      ans = 2;
      imageEnd.src = "static/image/2.png"
    }else if (n1 < 807666){
      ans = 1;
      imageEnd.src = "static/image/1.png"
    }else{
      ans = 0;
      imageEnd.src = "static/image/0.png"
    }
    ...
    if (n1 < 197293){
      ans = 7;
      imageEnd.src = "static/image/7.png"
    }else if (n1 < 416398){
      ans = 8;
      imageEnd.src = "static/image/8.png"
    }else if (n1 < 613683){
      ans = 9;
      imageEnd.src = "static/image/9.png"
    }else if (n1 < 758599){
      ans = 10;
      imageEnd.src = "static/image/10.png"
    }else if (n1 < 847973){
      ans = 11;
      imageEnd.src = "static/image/11.png"
    }else if (n1 < 898468){
      ans = 12;
      imageEnd.src = "static/image/12.png"
    }else if (n1 < 929737){
    ...
    if (n1 < 197293){
      ...
      imageEnd.src = "static/image/6.png"
      ans = 6;
    }else if (n1 < 847973){
      ans = 5;
      imageEnd.src = "static/image/5.png"
    }else if (n1 < 898468){
      ans = 4;
      imageEnd.src = "static/image/4.png"
    }else if (n1 < 929737){
      ...
      ans = 1;
      imageEnd.src = "static/image/1.jpg"
    }else{
      ans = 0;
      imageEnd.src = "static/image/0.png"
    }
